...
//    public MapsActivity(double latitud, double longitud){
...
//    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng currentPlace = new LatLng(latitud, longitud);
        //LatLng barcelona = new LatLng(41.39483307195536, 2.148767850000013);
        ...
        mMap.addMarker(new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.pin_3_48))
                        );
